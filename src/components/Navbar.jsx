const Navbar = () => {
  return (
    <div className="navbar bg-base-100 my-5 hidden">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul
            tabIndex={0}
            className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 text-[#150B2BB2] text-base font-normal"
          >
            <li>
              <a>Home</a>
            </li>
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal px-1 text-[#150B2BB2] text-base font-normal">
          <li>
            <a>Home </a>
          </li>
          <li>
      ...
      <div className="navbar-end flex gap-2">
        <div className=" hidden sm:block">
          <label className=" input flex items-center gap-2 rounded-full h-10 bg-[#150B2B0D]">
            <button>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 16 16"
                fill="currentColor"
                className="w-5 h-5 opacity-70 text-[#150B2BB2] hover:text-black"
              >
                <path
                  fillRule="evenodd"
            ...
            <input
              type="text"
              className="grow text-[#150B2BB2] text-base font-normal"
              placeholder="Search"
            />
          </label>
        </div>
